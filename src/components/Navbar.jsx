    ...
    <div id="navbtn" className="flex justify-between p-2 md:mx-6 relative">
      ...
      <div className="flex">
        ...
        <TooltipComponent content="Profile" position="BottomCenter">
          <div
            className="flex items-center gap-2 cursor-pointer p-1 ml-1 hover:bg-light-gray rounded-lg"
        ...
        {/* The states of these "isClicked" are updated by handleClick() in NavButtom */}
        {isClicked.cart && <Cart />}
        {isClicked.chat && <Chat />}
